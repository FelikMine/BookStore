                ...
                <div className='w-[90%] md:w-[80%] mt-8 md:mt-20'>
                    ...
                    <div className=" grid grid-cols-2 mt-5 gap-5 md:grid-cols-4 md:mt-10 md:gap-14">
                        ...
                        <OneBook
                            ...
                            image={Feather}
                            description2={"С Лавин её похитили для тёмного обряда, но даже побег обернулся роковой встречей — с тем, кто знает, как разговаривать с мёртвыми... и решать судьбы живых."}
                            link={"/necromancer"}
                        />
