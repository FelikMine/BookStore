...
export default function OneBook ({title, description, image, description2 , link, descriptionMobile}) {
    ...
    return (
        <>
            ...
            >
                ...
                <h3 className="z-10 !text-base text-center md:!text-2xl">{title}</h3>
            ...
            >
                ...
                <p className="text-center md:leading-5 leading-4 !text-xs md:!text-lg relative z-10">{ (isMobile) ? descriptionMobile : description2}</p>
